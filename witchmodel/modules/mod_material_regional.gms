...
$gdxin '%datapath%data_mod_lit'

parameter trade_poly_lit(n);
$loaddc trade_poly_lit

parameter trade_scale_lit(*);
$loaddc trade_scale_lit
...
cum_prodpp('lit',t,n) = max(0, trade_scale_lit('%fossil_lit%') *
                               poly(FPRICE.l('lit',t)/(twh2ej/1000), trade_poly_lit(n))
                           );
